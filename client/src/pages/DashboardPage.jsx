...
export default function DashboardPage() {
    ...
    const hasVSCodeData = !userLoading && (userData?.stats?.totalSecondsCoded ?? 0) > 0
    const hasGitHubData = !userLoading && !!(userData?.github?.username || userData?.github?.id)
    const showWelcome = !userLoading && !hasGitHubData && !hasVSCodeData
                    ...
                    <div className="px-5 py-4 border-b border-slate-200 dark:border-slate-700">
                        <div className="flex items-center justify-between gap-4">
                            <div>
                                ...
                                {['Last 3 Months', 'This Year', 'All Time'].includes(dateRange) && (
                                    <p className="text-xs text-slate-400 mt-0.5">Grouped by week</p>
                                )}
                            </div>
                            <DateRangePicker
        ...
        >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                {showWelcome ? (
                    <WelcomeScreen
                        user={user}
                        hasGitHub={hasGitHubData}
                        hasExtension={hasVSCodeData}
                    />
                ) : (
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
                                ...
                                <LanguagePieChart
                                    ...
                                    extensionLanguages={
                                        userData?.skills?.languages
                                            ? Object.fromEntries(Object.entries(userData.skills.languages))
                                            : {}
                                    }
                                />
                                <TechStackCard
                                    githubFrameworks={userData?.skills?.githubFrameworks || {}}
                                    frameworksTime={userData?.skills?.frameworksTime || {}}
                                />
                            </div>
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            <ActiveProjects />
                            <RecentActivity />
                            <DeveloperSummary userData={userData} githubStats={githubStats} />
                        </div>
                    </div>
                )}
